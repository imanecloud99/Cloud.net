...
<body>
	<div class="conseils" >
		<div class="conseils2">
			<img src="nos.png" alt="conseils" width="300px">
		</div>
	</div>
	<div class="center">
		<?php
		...
		$Query = "SELECT nompre, email, date, content FROM users join data on users.userid = data.userid where type = 'conseil'";
		...
		if (mysqli_num_rows($result) > 0) {
            ...
            echo "Pas de conseils pour le moment.";
         }
         mysqli_close($conn);
		?>
	</div>
